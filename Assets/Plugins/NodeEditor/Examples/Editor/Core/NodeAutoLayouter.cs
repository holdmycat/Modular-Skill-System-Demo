...
namespace Plugins.NodeEditor
{
    public class NodeAutoLayouter
    {
        ...
        {
            // Layout primarily on the horizontal axis.
            Horizontal = 1,

            // Layout primarily on the vertical axis.
            Vertical = Horizontal << 1,

            // Top-to-bottom, left-to-right traversal.
            Positive = Horizontal << 2,

            // Bottom-to-top, right-to-left traversal.
        ...
        public class TreeNode
        {
            ...
            public Vector2 GetPos()
            {
                ...
                // Root is at origin; rotate around origin and adjust because width/height swap.
