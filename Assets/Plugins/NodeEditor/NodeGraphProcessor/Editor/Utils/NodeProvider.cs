...
namespace GraphProcessor
{
	public static class NodeProvider
	{
		...
		{
			public NodeSpecificToGraph(Type _nodetype, List<MethodInfo> _isCompatibleWithGraph, Type _compatibleWithGraphType)
			{
				nodeType = _nodetype;
				isCompatibleWithGraph = _isCompatibleWithGraph;
				compatibleWithGraphType = _compatibleWithGraphType;
			}
			public Type				nodeType;
