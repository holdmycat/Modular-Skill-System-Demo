...
{
	// File: BaseNodeView.cs
	// Summary: GraphView node view wrapper that binds BaseNode runtime data to UI representation with port wiring and settings.
	// Note: Keep updates efficient; currently refreshes on any BaseNode change. Optimize if perf issues arise.
