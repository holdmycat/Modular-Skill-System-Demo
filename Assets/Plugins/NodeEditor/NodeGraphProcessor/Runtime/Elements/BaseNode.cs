...
namespace GraphProcessor
{
	...
	public abstract class BaseNode
	{
		...
		protected BaseNode()
		{
			...
			//Debug.Log("BaseNode Construction");
		}
		...
		/// <summary>
		/// Get all connected values for the given input port.
		/// </summary>
		/// <param name="fieldName"></param>
		...
		/// <summary>
		/// Get the first connected value for the given input port. Use TryGetAllInputValues for multiple.
		/// </summary>
		/// <param name="fieldName"></param>
		...
		/// <summary>
		/// Override to provide output value.
		/// </summary>
		/// <param name="outputPort">Output port</param>
		/// <param name="inputPort">Input port connected to outputPort</param>
		/// <param name="value">Value to fill</param>
		/// <typeparam name="T"></typeparam>
		public virtual void TryGetOutputValue<T>(NodePort outputPort, NodePort inputPort, ref T value)
		{
			Debug.LogError($"{this.GetType()} did not override TryGetOutputValue; output cannot be retrieved.");
		}
