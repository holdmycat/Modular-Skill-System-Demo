...
namespace GraphProcessor
{
	...
	/// <summary>
	/// Attribute controlling whether a port draws an icon. CustomPortBehavior should set icon data explicitly.
	/// </summary>
	[AttributeUsage(AttributeTargets.Field, AllowMultiple = false)]
	public class ShowPortIconAttribute : Attribute
	{
		...
		/// <summary>
		/// Optional override to match type name in USS when default type lookup fails (e.g., Dictionary -> Object).
		/// </summary>
