...
namespace Ebonor.DataCtrl
{
    public class NP_BBValue_List_Long : NP_BBValueBase<List<long>>, IEquatable<NP_BBValue_List_Long>
    {
        ...
        public override void SetValueFrom(INP_BBValue<List<long>> bbValue)
        {
        ...
        public static bool operator >(NP_BBValue_List_Long lhs, NP_BBValue_List_Long rhs)
        {
            Debug.LogError("你他妈确定对比两个List<long>大小关系？这是人能干出来的事？想对比自己写");
            return false;
        }
        ...
        {
            var copy = new NP_BBValue_List_Long();
            copy.Value = new List<long>(this.Value);
            return copy;
        }
    }
}
