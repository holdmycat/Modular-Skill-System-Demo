//------------------------------------------------------------
// File: NP_ClassForStoreAction.cs
// Created: 2025-12-01
// Purpose: Data container for serialized actions and metadata.
...
namespace Ebonor.DataCtrl
{
    ...
    public class NP_ClassForStoreAction
    {
        ...
        // Used to control conditional display in editors if needed
        ...
        /// <summary>
        /// Owning runtime behavior tree instance.
        /// </summary>
        [HideInInspector]
        ...
        /// <summary>
        /// Get the action to be executed; override to inject setup.
        /// </summary>
        ...
        public Action _CreateNPBehaveAction()
        {
            ...
            //log.Info($"{this.GetType()} _CreateNPBehaveAction failed: no delegate found to bind.");
            return null;
        }
    }
}
